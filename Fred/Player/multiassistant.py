...
from Fred.main import bot as app
from config import SUDO_USERS as SUDOERS
from Fred.Database.clientdb import get_assistant, save_assistant
from Fred.Client.assistant import get_assistant_details
from Fred.main import random_assistant
